package com.example.last.courier_activity;
...
import com.example.last.adapters.OrderRecyclerAdapter;
...
public class OrderListActivity extends AuthAbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_OrderCEL = new ChildEventListener() {
            ...
            private String getString(int err_firebase_unavailable) {
                return null;
            }
        };
    ...
    public void setContentView(int activity_order_list) {
    }
